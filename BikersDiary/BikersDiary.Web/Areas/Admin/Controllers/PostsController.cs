namespace BikersDiary.ForumSystem.Web.Areas.Admin.Controllers
{
    ...
    public class PostsController : BaseAdminController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Content,AuthorId,IsDeleted,DeletedOn,CreatedOn,ModifiedOn")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Content,AuthorId,IsDeleted,DeletedOn,CreatedOn,ModifiedOn")] Post post)
        {
            if (ModelState.IsValid)
            {
