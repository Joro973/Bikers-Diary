...
namespace Bikers_Diary.Areas.Admin.Controllers
{
    ...
    {
        public PostsController(DiaryData data)
            : base(data)
        {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Content,AuthorId,DatePublished")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Content,AuthorId,DatePublished")] Post post)
        {
            if (ModelState.IsValid)
            {
